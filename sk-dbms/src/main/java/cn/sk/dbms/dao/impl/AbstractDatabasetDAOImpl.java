		...
		try {
			...
			connection = DriverManager.getConnection(
					getUrl(connParam.getHost(), connParam.getPort(),
							connParam.getDbName())+"?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf8&useSSL=false", props);
